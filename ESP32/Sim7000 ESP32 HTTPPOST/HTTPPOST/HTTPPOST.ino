...
const char apn[]  = "wap.gprs.unifon.com.ar"; // Change this to your Provider details
...
// Server details
const char server[] = "jsonplaceholder.typicode.com"; // Change this to your selection
const char resource[] = "/posts";
const int  port = 80;
