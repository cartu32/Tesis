...
public class MapsActivtyPresenter {
    ...
    private static final String TAG = "MapsActivityPresenter";
        private final HashMap<String, Integer> hashMapId = new HashMap<String, Integer>();
        ...
        public void checkPermisson()
        {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
            {
                ...
                {
                    int MULTIPLE_PERMISSON_REQUEST_CODE = 10003;
        ...
        private void configureBroadcastReciever() {
            ...
            activity.getApplicationContext().registerReceiver(receiver, filtro, Context.RECEIVER_EXPORTED);
        ...
        public Location getLocation() {
            try {
                ...
                Log.e("getLocation", Objects.requireNonNull(e.getMessage()));
            }
            return location;
        }
        ...
        public iGeofence createRetrofitGeofence(String id, LatLng latLng, float radius){
            iGeofence obj = new iGeofence();
            obj.setIdArea(id);
        ...
        public void updateCircleRadius(float geofenceRadius){
            ...
            iGeofence aux = listAreaAddedManual.get(listAreaAddedManual.size() - 1);
        ...
        public class ReceptorOperation extends BroadcastReceiver {
            public void onReceive(Context context, Intent intent) {
                ...
                operacion = Objects.requireNonNull(intent.getExtras()).getInt("Operacion");
