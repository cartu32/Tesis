package com.example.geofencing.Connection;
...
public class MqttHandler implements MqttCallback {
    ...
    public static final String USER="BBFF-KlzMyMgB7jnNEgxnrFVIUkHKJ0hVan";
    public static final String PASS="BBFF-KlzMyMgB7jnNEgxnrFVIUkHKJ0hVan";

    public static final String TOPIC_PULSADOR = "/v1.6/devices/asaa/pulsador";
    public static final String TOPIC_GPS      = "/v1.6/devices/dispositivo1/position";
