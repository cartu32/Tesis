package com.example.appbarscaffold.model

//Este son los datos, de una base de datos por ejemplo, que se van a mostrar en por pantalla a traves de mainscreen
// y medialist
